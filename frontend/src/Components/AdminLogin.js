        ...
        <div className='fs-4 fw-bold top text-center my-2  '>
            ...
            <div className="mb-3 row my-2 d-flex flex-column fw-semibold" style={{fontSize:"12px"}}>
                ...
                <div className="col-sm-10">
                    <input type="text" className="fs-6 fw-bold form-control-plaintext mx-3 px-1 border-bottom" placeholder="Enter atleast 6 character" name='username' onChange={onChange} style={{ fontFamily: 'Kanit' }} />
                </div>
            </div>
            <div className="mb-3 row my-2 d-flex flex-column fw-semibold" style={{fontSize:"12px"}}>
                ...
                }}  onChange={onChange} placeholder='Type your password' />
                </div>
            </div>
